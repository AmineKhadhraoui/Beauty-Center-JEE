                ...
                <div class="carousel-item position-relative active" style="min-height: 100vh;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <p class="mx-md-5 px-5">Indulge in the ultimate relaxation and wellness experience with our premium massage treatments at the spa center.
                             Our highly trained therapists use a variety of techniques to target your specific needs, from easing tense muscles and improving circulation to reducing stress and promoting a sense of tranquility.</p>
                ...
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <p class="mx-md-5 px-5">Transform your skin and revive your natural glow with our luxurious facial treatments at the spa center.
                             Our experienced estheticians use only the highest quality products and techniques to deliver personalized facials that cater to your unique skin concerns, whether it's hydration, anti-aging, or deep cleansing.</p>
                            <a class="btn btn-outline-light py-3 px-4 mt-3 animate__animated animate__fadeInUp" href="appointment">Make Appointment</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item position-relative" style="min-height: 100vh;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <p class="mx-md-5 px-5">Say goodbye to stubborn cellulite with our targeted cellulite treatment at the spa center.
                             Our trained professionals use the latest technologies and techniques to address the root causes of cellulite, including poor circulation, excess fat, and weakened connective tissue. </p>
                            <a class="btn btn-outline-light py-3 px-4 mt-3 animate__animated animate__fadeInUp" href="appointment.html">Make Appointment</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="pl-4 border-left border-primary">Welcome to Your Best Spa, Beauty & Skin Care Center, where we're committed to helping you look and feel your best.
                     Our spa center offers a wide range of services, including massages, facials, hair removal, and body treatments, each designed to cater to your individual needs and preferences.
                      Our highly skilled professionals use only the highest quality products and techniques to deliver exceptional results that leave you feeling refreshed, revitalized, and renewed.</p>
                    <div class="row pt-3">
                        <div class="col-6">
                            <div class="bg-light text-center p-4">
                                <h3 class="display-4 text-primary" data-toggle="counter-up">128</h3>
                                <h6 class="text-uppercase">Spa Specialist</h6>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="bg-light text-center p-4">
                                <h3 class="display-4 text-primary" data-toggle="counter-up">489</h3>
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Emma</h6>
                                    <span>Marketing Manager</span>
                                </div>
                            </div>
                            <p class="m-0">I had an amazing experience at the spa and beauty center. The massage was so relaxing and the facial left my skin looking and feeling amazing. Can't wait to go back!</p>
                        </div>
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Elizabeth</h6>
                                    <span> Fitness Trainer</span>
                                </div>
                            </div>
                            <p class="m-0">The spa and beauty center is my go-to place for self-care. The atmosphere is so serene and the staff is always so friendly and accommodating. Highly recommend!</p>
                        </div>
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    <h6 class="text-uppercase">Lily</h6>
                                    <span> Software Engineer</span>
                                </div>
                            </div>
                            <p class="m-0">I was really impressed by the attention to detail at the spa and beauty center. From the high-quality products to the skilled professionals, everything was top-notch. Definitely worth a visit.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 pr-lg-5 mb-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="mb-3 text-white"><span class="text-primary">Amina Beauty</span> Center</h1>
                    </a>
